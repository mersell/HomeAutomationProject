...
FINAL_IMAGE=${DISTDIR}/board1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=board1_main.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/board1_main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/board1_main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/board1_main.o

# Source Files
SOURCEFILES=board1_main.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/board1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F877A
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/board1.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/board1_main.o: board1_main.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/board1_main.o 
	${MP_AS} -mcpu=PIC16F877A -c \
	-o ${OBJECTDIR}/board1_main.o \
	board1_main.asm \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/board1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F877A ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/board1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \

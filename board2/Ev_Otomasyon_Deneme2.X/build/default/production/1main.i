...
;PORT + ADC CONFIGURATION
    ...
    BANKSEL TRISB
    movlw 0x0F ; Set ((PORTB) and 07Fh), 0 -((PORTB) and 07Fh), 3 as inputs, ((PORTB) and 07Fh), 4 -((PORTB) and 07Fh), 7 as outputs.
    movwf TRISB

    BANKSEL TRISA
    movlw 0x03 ; Set ((PORTA) and 07Fh), 0 and ((PORTA) and 07Fh), 1 as inputs.
    movwf TRISA
    ...
    movwf TRISC ; ((PORTC) and 07Fh), 7(RX) input, ((PORTC) and 07Fh), 6(TX) output, ((PORTC) and 07Fh), 3/4 I2C.

# 1 "2ReadingLDRPOTviaADC.asm"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 296 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "2ReadingLDRPOTviaADC.asm" 2
PROCESSOR 16F877A
...
read_sensors:
    ;SECTION 1: LDR READING (AN0 - ((PORTA) and 07Fh), 0)
    BANKSEL ADCON0
    ...
    BANKSEL ADCON0
    bsf ADCON0, 2 ; Set ((ADCON0) and 07Fh), 2/DONE bit to start ADC conversion.

wait_ldr:
    BANKSEL ADCON0
    btfsc ADCON0, 2 ; Check if ((ADCON0) and 07Fh), 2/DONE bit = 0.
    ...
    ;SECTION 2: POTENTIOMETER READING (AN1 - ((PORTA) and 07Fh), 1)
    BANKSEL ADCON0

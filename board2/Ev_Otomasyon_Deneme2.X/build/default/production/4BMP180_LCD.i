...
lcd_send_command:
    ...
    BANKSEL PORTE
    bcf PORTE, 0 ; Register Select on ((PORTE) and 07Fh), 0 [cite: 925-926]. ; Select command mode (RS = 0).
    bcf PORTE, 2 ; Select write mode (RW = 0).
    bsf PORTE, 1 ; Enable Pulse on ((PORTE) and 07Fh), 1 [cite: 927-928]. ; Enable pulse starts (EN = 1).
    call delay_short ; Short delay for LCD timing.
    bcf PORTE, 1 ; Enable Pulse on ((PORTE) and 07Fh), 1 [cite: 927-928]. ; Latch command (EN = 0).
...
lcd_char:
    ...
    BANKSEL PORTE
    bsf PORTE, 0 ; Register Select on ((PORTE) and 07Fh), 0 [cite: 925-926]. ; Select character mode (RS = 1).
    bcf PORTE, 2 ; Select write mode (RW = 0).
    bsf PORTE, 1 ; Enable Pulse on ((PORTE) and 07Fh), 1 [cite: 927-928]. ; Enable pulse starts (EN = 1).
    call delay_short ; Short delay for LCD timing.
    bcf PORTE, 1 ; Enable Pulse on ((PORTE) and 07Fh), 1 [cite: 927-928]. ; Latch data (EN = 0).
